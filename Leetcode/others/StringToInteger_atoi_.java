...
public class StringToInteger_atoi_ {
	...
	public static int atoi(String str) {
		...
		// calculate value: if str.charAt(i) is 'a' '@' or other stuff.....
		// Ignore them and stop
	...
	public static void main(String[] args) {
		// this one is bigger than Integer.MAX_VALUE:
		// use a long to store temporarily
		System.out.println(atoi("9912919993df"));
	}
}
