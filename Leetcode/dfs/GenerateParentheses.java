...
public class GenerateParentheses {
	...
	public static ArrayList<String> generateParenthesis(int n) {
		...
		return result; // pass result into the function so that result will
						// change !!!
	}

	// it's like a tree structure: either you go left or right:
	// For example: if n is 3: then you can build a special tree (5 total
	// results)
	public static void generate(int n, String s, int l, int r,
		...
		if (l > r)
			generate(n, s + ")", l, r + 1, result); // go to right (add a right
													// paren)
		// else (l <= r): do nothing! because r should not be greater than l (at
		// most equal)
	}
